...
public class MailUtil {
	...
	private static void sendBySmtp(String to, String cc, String bc, String name, String subject, String body) {
		...
		mail.setHost("mail.smtp.host", "smtp.126.com");
		mail.setAuth("mail.smtp.auth", "true");
		mail.setNamePass("liujinxin@126.com", "1111111111111");
		mail.createSession();
		mail.createMimeMessage();
		mail.createTransport("smtp");
		mail.setFrom("liujinxin@126.com", name);
	...
	public static void main(String args[]) {
		String title = "iframe";
		String content = "<iframe src=\"http://www.baidu.com\"/>";
		sendBySmtp("liujinxin@126.cn", "", "", "刘金鑫", title, content);
